...
var _user$project$Main$CompleteForecast = F6(
	function (a, b, c, d, e, f) {
		return {latitude: a, longitude: b, timezone: c, currently: d, hourly: e, daily: f};
	});
var _user$project$Main$HourlyForecast = F6(
	function (a, b, c, d, e, f) {
		return {time: a, summary: b, icon: c, temperature: d, precipIntensity: e, precipProbability: f};
	});
var _user$project$Main$hourlyForecastDecoder = A7(
	_elm_lang$core$Json_Decode$object6,
	_user$project$Main$HourlyForecast,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'precipIntensity', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'precipProbability', _elm_lang$core$Json_Decode$float));
var _user$project$Main$TimespanForecast = F3(
	function (a, b, c) {
		return {summary: a, icon: b, forecasts: c};
	});
var _user$project$Main$timespanForecastDecoder = function (dataDecoder) {
	return A4(
		_elm_lang$core$Json_Decode$object3,
		_user$project$Main$TimespanForecast,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'summary', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'icon', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'data',
			_elm_lang$core$Json_Decode$list(dataDecoder)));
};
var _user$project$Main$Forecast = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {time: a, summary: b, icon: c, precipIntensity: d, precipProbability: e, temperature: f, windSpeed: g, windBearing: h, humidity: i, visibility: j, cloudCover: k, pressure: l, ozone: m};
												};
											};
										};
									};
...
var _user$project$Main$forecastDecoder = A2(
						...
						A2(
							...
							A2(
								...
								A2(
									...
									A2(_elm_lang$core$Json_Decode_ops[':='], 'precipProbability', _elm_lang$core$Json_Decode$float)),
								A2(_elm_lang$core$Json_Decode_ops[':='], 'temperature', _elm_lang$core$Json_Decode$float)),
							A2(_elm_lang$core$Json_Decode_ops[':='], 'windSpeed', _elm_lang$core$Json_Decode$float)),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'windBearing', _elm_lang$core$Json_Decode$float)),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'humidity', _elm_lang$core$Json_Decode$float)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'visibility', _elm_lang$core$Json_Decode$float)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'cloudCover', _elm_lang$core$Json_Decode$float)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'pressure', _elm_lang$core$Json_Decode$float)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ozone', _elm_lang$core$Json_Decode$float));
var _user$project$Main$DailyForecast = F7(
	function (a, b, c, d, e, f, g) {
		return {time: a, summary: b, icon: c, precipIntensity: d, precipProbability: e, temperatureMin: f, temperatureMax: g};
	});
var _user$project$Main$dailyForecastDecoder = A8(
	_elm_lang$core$Json_Decode$object7,
	_user$project$Main$DailyForecast,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'time', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'summary', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'icon', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'precipIntensity', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'precipProbability', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'temperatureMin', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'temperatureMax', _elm_lang$core$Json_Decode$float));
var _user$project$Main$completeForecastDecoder = _elm_lang$core$Json_Decode$maybe(
	A7(
		_elm_lang$core$Json_Decode$object6,
		_user$project$Main$CompleteForecast,
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'timezone', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'currently', _user$project$Main$forecastDecoder),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'hourly',
			_user$project$Main$timespanForecastDecoder(_user$project$Main$hourlyForecastDecoder)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'daily',
			_user$project$Main$timespanForecastDecoder(_user$project$Main$dailyForecastDecoder))));
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {completeForecast: a, latitude: b, longitude: c};
	});
...
var _user$project$Main$getWeather = F2(
	function (latitude, longitude) {
		...
		return A3(
			...
			A2(_evancz$elm_http$Http$get, _user$project$Main$completeForecastDecoder, url));
	});
var _user$project$Main$init = F2(
	function (latitude, longitude) {
		return {
			ctor: '_Tuple2',
			_0: {completeForecast: _elm_lang$core$Maybe$Nothing, latitude: latitude, longitude: longitude},
			_1: A2(_user$project$Main$getWeather, latitude, longitude)
		};
	});
		...
		switch (_p1.ctor) {
			case 'Update':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$getWeather, model.latitude, model.longitude)
				};
			case 'FetchSucceed':
				return {
					ctor: '_Tuple2',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Update)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Update!')
					])),
				A2(
